...
function addMailbox(cfg, opts, data)
  ...
  if data.password ~= nil then
    ...
    new_line = new_line .. " userdb_sieve=/var/mail/" .. data.contract .. "/" .. data.id .. "/dovecot.sieve userdb_sieve_dir=/var/mail/" .. data.contract .. "/" .. data.id .. "/sieve"
  end
  ...
  -- TODO: fix the autoresponder feature, currently it's incompatible with paswd userdb setting
  -- userdb_sieve_dir=.../sieve (dovecot.sieve is now a symlink)
