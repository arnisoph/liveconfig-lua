...
-- $Id: web.lua 2819 2014-03-26 14:21:52Z kk $
-- ---------------------------------------------------------------------------
...
function deleteAccount(name)
  ...
  if home ~= nil and LC.fs.is_dir(home) and home ~= "/" and name ~= "" then
    ...
    os.execute("chattr -f -i " .. home .. "/conf/*/php.ini")
    os.execute("chattr -f -i " .. home .. "/conf/*/php-fcgi-starter")
